...
import com.mycompany.proyecto.service.InsumoService;
...
public class InsumoController {
	...
	@Autowired
	public InsumoController(InsumoService is){
		this.insumoService = is;
	}
...
//	}
	...
	public String listar(Model uiModel) {
		uiModel.addAttribute("insumos", insumoService.getAll());
	...
	public String crearForm(Model uiModel) {
		uiModel.addAttribute("insumo", new Insumo());
	...
	public String crear(@Valid Insumo insumo, BindingResult bindingResult, Model uiModel) {
		if (bindingResult.hasErrors()) {
            uiModel.addAttribute("insumo", insumo);
            uiModel.addAttribute("active", "incluir");
            return "incluirInsumo";
        }
		
		this.insumoService.save(insumo);
		log.debug("Insumo persistido: "+ insumo.getCodigo());
	...
	public String editarForm(@PathVariable("id") Long id, Model uiModel) {
		Insumo m = insumoService.findById(id);
		if (m != null) {
			uiModel.addAttribute("insumo", m);
	...
	public String editar(@Valid Insumo insumo, BindingResult bindingResult, Model uiModel) {
		if (bindingResult.hasErrors()) {
            uiModel.addAttribute("insumo", insumo);
            return "editarInsumo";
        }
		this.insumoService.save(insumo);
		log.debug("Insumo actualizado: " + insumo.getCodigo());
		return "redirect:/insumo/listado";
	}
