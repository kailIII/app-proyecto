...
<div>
	...
	<table class="table table-hover">
		...
		<tr>
			<td>${m.codigo}</td>
			<td>
				<spring:url value="/impuesto/${m.codigo}" var="edit_url" htmlEscape="true">
				</spring:url>
	...
	<spring:url value="/impuesto" var="crear_url" htmlEscape="true">
		<spring:param name="form"></spring:param>
	</spring:url>
    <a href="${crear_url}">Registrar Impuesto</a>
</div>