...
<form:form action="" method="${param.method}" modelAttribute="compra" class="form-horizontal" id="frmCompra">
	...
	<fieldset>
   		...
   		<div class="control-group">
    		<label class="control-label">${label_proveedor}</label>
    		<div class="controls">
   		...
   		<div class="control-group">
    		<label class="control-label">${label_deposito}</label>
    		<div class="controls">
...
<!--    		<div class="control-group"> -->
<%--     		<label class="control-label">${label_usuario}</label> --%>
<!--     		<div class="controls"> -->
<%--     			<form:input path="usuario.codigo" class="input-small"/> --%>
<%--     			<form:errors path="usuario.codigo" cssClass="alert alert-error" /> --%>
<!--     		</div> -->
<!--    		</div> -->
