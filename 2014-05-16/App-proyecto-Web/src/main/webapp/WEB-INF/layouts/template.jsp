...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="${bootstrap_url}" /> <!-- required for FF3 and Opera -->
		<link rel="stylesheet" type="text/css" media="screen" href="${css_url}" /> <!-- required for FF3 and Opera -->
